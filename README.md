...
[Hub 地址](https://hub.docker.com/repository/docker/toroling/chatgpt-web/general)
...
services:
  app:
    image: toroling/chatgpt-web # 总是使用 latest ,更新时重新 pull 该 tag 镜像即可
    ports:
      - 3002:3002
    environment:
      # 二选一
